...
<div class="card">
              <div class="card-header">
                <h3 class="card-title">Datos del Centro Productivo seleccionado</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form id="form-centro-edit" method="GET" action="{{ route('centro.edit', $centro->id) }}">
              ...
              <div class="card-body">
                ...
                <div class="row">
                    ...
                    <x-adminlte-input type="text" name="nombre" label="Nombre" placeholder="Ingrese el nombre del Centro Productivo"  label-class="text-lightblue" value="{{$centro->nombre}}" disabled>
                    ...
                    <x-adminlte-input type="text" name="razon_social" label="Razón Social" placeholder="Ingrese la Razón Social de su empresa u organización" label-class="text-lightblue" value="{{$centro->razon_social}}" disabled>
                ...
                <div class="row">
                    ...
                    <x-adminlte-input type="text" name="CIF" label="CIF" placeholder="Ingrese el CIF de su empresa u organización " label-class="text-lightblue" value="{{$centro->CIF}}" disabled>
                    ...
                    <x-adminlte-input type="text" name="provincia" label="Provincia" placeholder="Ingrese la Provincia del Centro Productivo" label-class="text-lightblue" value="{{$centro->provincia}}" disabled>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <x-adminlte-input type="text" name="localidad" label="Localidad" placeholder="Ingrese la localidad del Centro Productivo" label-class="text-lightblue" value="{{ $centro->localidad }}" disabled>
                    ...
                    <div class="col">
                            ...
                            <x-adminlte-input type="text" name="codigo_postal" label="Código Postal" placeholder="Ingrese el código postal del Centro Productivo" label-class="text-lightblue" value="{{ $centro->codigo_postal }}" disabled>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <x-adminlte-input type="text" name="pais" label="País" placeholder="Ingrese el país del Centro Productivo" label-class="text-lightblue" value="{{ $centro->pais }}" disabled>
                    ...
                    <div class="col">
                        ...
                        <div class="form-group ">
                         ...
                         <div class="input-group-prepend">
                            ...
                            <select name="estilo" class="form-control text-dark" id="estilo" disabled>
                 ...
                 <div class="row">
                    ...
                    <div class="col">
                        ...
                        <x-adminlte-textarea name="direccion" label="Dirección" rows=3 label-class="text-lightblue"
                            igroup-size="sm" placeholder="Ingrese la Dirección del Centro Productivo" disabled>
                ...
                <x-adminlte-button class="btn-flat" type="submit" label="Editar Centro" theme="success" icon="fa-lg fas fa-pen" />
